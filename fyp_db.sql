...
CREATE TABLE `chat_group` (
  ...
  `role` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'role',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='chat group table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `chat_group` VALUES (44,1,2,'USER'),(45,2,1,'COACH'),(46,1,6,'USER'),(47,6,1,'COACH'),(48,2,6,'USER'),(49,6,2,'COACH'),(50,1,1,'USER'),(51,1,1,'COACH'),(52,3,6,'USER'),(53,6,3,'COACH'),(54,6,6,'USER'),(55,6,6,'COACH'),(56,2,5,'USER'),(57,5,2,'COACH'),(58,4,5,'USER'),(59,5,4,'COACH'),(60,1,5,'USER'),(61,5,1,'COACH'),(62,2,7,'USER'),(63,7,2,'COACH'),(64,1,7,'USER'),(65,7,1,'COACH'),(66,3,7,'USER'),(67,7,3,'COACH'),(68,4,7,'USER'),(69,7,4,'COACH'),(70,6,7,'USER'),(71,7,6,'COACH'),(72,5,6,'USER'),(73,6,5,'COACH');
...
CREATE TABLE `chat_info` (
  ...
  `role` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'role',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='chat info table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (5,'user0','123','Sam','http://localhost:9090/files/1741042073957-avatar-user..png','USER','0123456789','user0@example.com',139.00),(6,'user1','123','Jing','http://localhost:9090/files/1741042088305-avatar-user..png','USER','0123456789','user1@example.com',139.00),(7,'user2','123','Geralt','http://localhost:9090/files/1741042255029-avatar-user..png','USER','0123456789','user2@example.com',76.00);
...
-- Dump completed on 2025-05-05  7:38:27
