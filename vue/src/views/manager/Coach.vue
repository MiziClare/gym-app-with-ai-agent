    ...
    <div>
      ...
      <div class="table">
        <el-table :data="tableData" strip @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="content" label="Introduction"></el-table-column>
      ...
      <el-dialog title="Coach Information" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
        <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
          ...
          <el-form-item label="Intro" prop="content">
            <el-input type="textarea" :rows="4" v-model="form.content" placeholder="Enter introduction"></el-input>
          </el-form-item>
        </el-form>
