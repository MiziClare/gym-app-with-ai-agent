<template>
  <div>
    ...
    <el-dialog title="Admin Management" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
...
export default {
  ...
  methods: {
    ...
    save() {   // Save button logic for add or update
