  ...
  routes: [
    ...
    { path: '/scan', component: ScanView, meta: { roles: ['ADMIN', 'COACH'] as Role[] } },
    {
      ...
      children: [
        ...
        feature('connections', 'connections', 'Coach connections'),
        ...
        feature('myExperience', 'myPosts', 'My posts'),
        feature('savedPosts', 'savedPosts', 'Saved posts'),
        feature('forumMessages', 'forumMessages', 'Forum messages'),
    ...
    },
    {
      ...
      children: [
        ...
        admin('experience/:id', 'postDetail', 'Post details'),
        admin('forum-feedback', 'forumFeedback', 'Forum feedback'),
      ],
    },
